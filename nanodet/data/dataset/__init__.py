...
from .coco import CocoDataset, CocoDataset2, CocoDataset3, CocoDataset4
...
def build_dataset(cfg, mode):
    ...
    if name == "coco":
        ...
        return CocoDataset(mode=mode, **dataset_cfg)
    elif name == "CocoDataset2":
        return CocoDataset2(mode=mode, **dataset_cfg)
    elif name == "CocoDataset3":
        return CocoDataset3(mode=mode, **dataset_cfg)
    elif name == "CocoDataset4":
        return CocoDataset4(mode=mode, **dataset_cfg)
