...
class ConvModule(nn.Module):
    ...
    def __init__(
        ...
        if self.with_norm:
            ...
            # print(self.norm_name,norm)
            # self.add_module(self.norm_name, norm)
            self.norm_name, self.norm_layer = build_norm_layer(norm_cfg, norm_channels)
    ...
    # @property
    # def norm(self):
    #     # print(self.norm_name)
    #     if self.norm_name == "bn":
    #         # print(self.bn)
    #         return self.bn
    #     elif self.norm_name == "gn":
    #         # print(self.gn)
    #         if not self.gn:
    #             return self.bn
    #         # print(self.gn)
    ...
    #     # if self.norm_name:
    #     #     # print(self.norm_name)
    #     #     temp = getattr(self, self.norm_name)
    #     #     # print(self.)
    #     #     # print(temp)
    #     #     return temp
    #     else:
        ...
        for layer_name in self.order:
            if layer_name != "act":
                if layer_name == "depthwise":
                    x = self.depthwise(x)
                if layer_name == "dwnorm":
                    x = self.dwnorm(x)
                if layer_name == "pointwise":
                    x = self.pointwise(x)
                if layer_name == "pwnorm":
                    x = self.pwnorm(x)
